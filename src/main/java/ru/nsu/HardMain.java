...
//        System.out.println("scanning = " + scanningConfig);
        ...
        System.out.println("Singleton beans = " + instantiationService.getDependencyContainer().getSingletonInstances());
        System.out.println("Thread beans = " + instantiationService.getDependencyContainer().getThreadInstances());
    }
}
